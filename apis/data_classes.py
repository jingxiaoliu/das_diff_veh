...
class SurfaceWaveSelector:
    ...
    def save_figs(self, muted=False, offset=450, fig_dir="Fig/show_sw_time_windows/", k_start = 0):
        for k, win in enumerate(self):
            ...
            if muted:
                ...
                win_to_save = win
            win_to_save.save_fig(fig_name=f"{fig_prefix}{k+k_start}.png", fig_dir=fig_dir)
